...
export default function Header({ scroll, isMobileMenu, handleMobileMenu }: any) {
    return (
        <>
            <header>
                <div className="">
                    <nav className={`navbar navbar-expand-lg z-30 bg-1 ${scroll ? "navbar-stick top-0 position-fixed w-100" : ""}`}>
                        <div className="container mt-3 mb-3">
                            <Link className="navbar-brand me-auto" href="/">
                                <Image src="/favicon.ico" alt="The Degree Gap Logo" width={50} height={50} />
                                <h5 className="mb-0" style={{ color: '#800020' }}>The Degree Gap</h5>
                            </Link>
                            <div className="d-none d-lg-flex me-lg-4">
                                <MainMenu />
                            </div>
                    ...
                    <div className="offCanvas__info">
                        ...
                        <div className="offCanvas__logo mb-30">
                            <Link className="d-flex align-items-center gap-2" href="/">
                                ...
                                <h5 className="mb-0 text-dark">Expert Tutoring</h5>
                            </Link>
                        </div>
