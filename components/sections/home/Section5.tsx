...
export default function Section5() {
    return (
        <>
            {/*seo-agency-home section 5*/}
            <section id="pricing" className="seo-agency-home-section-5 position-relative overflow-hidden py-120 @@bg">
                            ...
                            <div className="card-pricing bg-white rounded-4 border p-md-6 p-4">
                                ...
                                <ul className="list-unstyled mt-3 mb-0">
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                                        <p className="fs-7 mb-0">FREE 15 minute consultation</p>
                                        <img src="assets/imgs//template/icons/check.svg" alt="The Degree Gap" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                                        <p className="fs-7 mb-0">Personally interviewed by founders</p>
                                        <img src="assets/imgs//template/icons/check.svg" alt="The Degree Gap" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                                        <p className="fs-7 mb-0">Structured plans for each subject</p>
                                        <img src="assets/imgs//template/icons/check.svg" alt="The Degree Gap" />
                                    </li>
                        ...
                        <div className="col-lg-4">
                            <div className="card-pricing bg-white rounded-4 border border-primary p-md-6 p-4 position-relative">
                                ...
                                <ul className="list-unstyled mt-3 mb-0">
                                    ...
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                                        <p className="fs-7 mb-0 ">Positive feedback from previous students</p>
                                        <img src="assets/imgs//template/icons/check.svg" alt="The Degree Gap" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary pt-3">
                                        <p className="fs-7 mb-0">2+ years of tutoring experience</p>
                                        <img src="assets/imgs//template/icons/check.svg" alt="The Degree Gap" />
                                    </li>
                                </ul>
                                <span className="sale-off text-primary fs-8 position-absolute top-0 end-0 me-6 px-3"></span>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="card-pricing bg-white rounded-4 border p-md-6 p-4">
                                ...
                                <ul className="list-unstyled mt-3 mb-0">
                                    ...
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                                        <p className="fs-7 mb-0">Educational roadmap</p>
                                        <img src="assets/imgs//template/icons/check.svg" alt="The Degree Gap" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                                        <p className="fs-7 mb-0">Professionalism on every single level</p>
                                        <img src="assets/imgs//template/icons/check.svg" alt="The Degree Gap" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary pt-3">
                                        <p className="fs-7 mb-0">Top tutors in the country</p>
                                        <img src="assets/imgs//template/icons/check.svg" alt="The Degree Gap" />
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div className="row mt-8">
                        <div className="d-flex flex-wrap align-items-center justify-content-center gap-5">
                            ...
                            <div className="d-flex align-items-center gap-3">
                                ...
                                <p className="text-dark mb-0">Book at any point</p>
                            </div>
                        </div>
                    </div>
                </div>
