                        ...
                        <div className="col-lg-5 offset-lg-1 d-none d-lg-block">
                            <div className="p-4 rounded-4" style={{ 
                                ...
                                <div className="py-4 text-center">
                                    ...
                                    <p className="mb-0" style={{ fontSize: '0.95rem', color: '#000' }}>Join hundreds who have improved their grades with our tutors</p>
                                </div>
                                <form action="https://formspree.io/f/mldelvzl" method="POST" className="input-group mb-2 position-relative">
                                    <div className="row g-2">
                                        ...
                                        <div className="col-12 mt-3">
                                            <button type="submit" className="btn d-flex align-items-center w-100 justify-content-center py-2" style={{ backgroundColor: '#FFD700', color: 'black', borderColor: '#FFD700', fontWeight: '600' }}>
