...
export default function Section2() {
    return (
        <>
            {/*seo-agency blog section 2*/}
            <section className="seo-agency-blog-section-2 position-relative overflow-hidden pb-80">
                        ...
                        <div className="d-flex justify-content-center align-items-center">
                            <nav aria-label="Page navigation example">
                                <ul className="pagination gap-2">
                                    ...
                                    <li className="page-item">
                                        <Link className="icon-md fs-5 active page-link pagination_item border-0 icon-shape fw-regular" href="#">
                                            2
                                        </Link>
                                    </li>
                                    <li className="page-item">
