export default function Section2() {
    return (
        <>
            {/*seo-agency pricing section 2*/}
            <section className="seo-agency-pricing-section-2 position-relative overflow-hidden py-120">
                <div className="container">
                    <div className="table-responsive wow img-custom-anim-top">
                        <table className="table rounded-4 overflow-hidden">
                            <thead>
                                <tr>
                                    <th className="py-3 border-bottom-0" scope="col" />
                                    <th className="py-3 border-bottom-0" scope="col">
                                        <span className="text-capitalize text-dark fs-20">Free</span>
                                    </th>
                                    <th className="py-3 border-bottom-0" scope="col">
                                        <span className="text-capitalize text-dark fs-20">Starter</span>
                                    </th>
                                    <th className="py-3 border-bottom-0" scope="col">
                                        <span className="text-capitalize text-dark fs-20">Business</span>
                                    </th>
                                    <th className="py-3 border-bottom-0" scope="col">
                                        <span className="text-capitalize text-dark fs-20">Enterprise</span>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <th className="py-3 mt-4 bg-light border-bottom-0 rounded-start-3" scope="row">
                                        <span className="text-nowrap btn-text fs-7">Task Management</span>
                                    </th>
                                    <td className="py-3 bg-light border-bottom-0" />
                                    <td className="py-3 bg-light border-bottom-0" />
                                    <td className="py-3 bg-light border-bottom-0" />
                                    <td className="py-3 bg-light border-bottom-0 rounded-end-3" />
                                </tr>
                                <tr>
