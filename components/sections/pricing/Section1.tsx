...
export default function Section1() {
    return (
        <>
            {/*seo-agency pricing section 1*/}
            <section className="seo-agency-pricing-section-1 position-relative overflow-hidden py-90 border-bottom">
                <div className="container position-relative z-1">
                    <div className="row">
                        <div className="text-center pb-80">
                            ...
                            <p className="wow img-custom-anim-top">Best for freelance developers who need to save their time</p>
                        </div>
                    </div>
                    <div className="row g-lg-5 g-4">
                        <div className="col-lg-4">
                            <div className="card-pricing rounded-4 border p-md-6 p-4" data-aos="fade-up" data-aos-delay={0}>
                                ...
                                <ul className="list-unstyled mt-3 mb-0">
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                                        ...
                                        <img src="assets/imgs//template/icons/check.svg" alt="The Degree Gap" />
                                    </li>
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary py-3">
                                    ...
                                    <li className="d-flex align-items-center justify-content-between border-top border-secondary pt-3">
                        ...
                        <div className="col-lg-4">
                            <div className="card-pricing rounded-4 border border-primary p-md-6 p-4 position-relative" data-aos="fade-up" data-aos-delay={200}>
                                <span className="text-primary btn-text">advanced</span>
                                <h1 className="mb-3">$299</h1>
                                <p className="fs-7">Best for small business owners, startups who needes landing page.</p>
                                ...
                                <span className="sale-off text-primary fs-8 position-absolute top-0 end-0 me-6 px-3">Most popular</span>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="card-pricing rounded-4 border p-md-6 p-4" data-aos="fade-up" data-aos-delay={400}>
                                <span className="text-primary btn-text">team</span>
                                <h1 className="mb-3">$499</h1>
                                <p className="fs-7">Best for small business owners, startups who needes landing page.</p>
                                <Link href="#" className="btn btn-outline-dark w-100 mb-6">
                                    try for free
                                </Link>
                    ...
                    <div className="row mt-8">
                        <div className="d-flex flex-wrap align-items-center justify-content-center gap-5">
                            ...
                            <div className="d-flex align-items-center gap-3" data-aos="fade-up" data-aos-delay={400}>
                                ...
                                <p className="text-dark mb-0">No hidden contracts</p>
                            </div>
