...
export default function Section3() {
    return (
        <>
            ...
            <section className="seo-agency-home-section-5 position-relative overflow-hidden py-120 bg-light-2">
                <div className="container position-relative z-1">
                    <div className="row">
                        <div className="text-center pb-80">
                            ...
                            <h2 className="text-anime-style-3">Expertise service price</h2>
                        </div>
                    </div>
                    <div className="row g-lg-5 g-4">
                        <div className="col-lg-4">
                            <div className="card-pricing bg-white rounded-4 border p-md-6 p-4" data-aos="fade-up" data-aos-delay={0}>
                                ...
                                <Link href="/pricing" className="btn btn-outline-dark w-100 mb-6">
                                    try for free
                                </Link>
                        ...
                        <div className="col-lg-4">
                            <div className="card-pricing bg-white rounded-4 border border-primary p-md-6 p-4 position-relative" data-aos="fade-up" data-aos-delay={200}>
                                ...
                                <p className="fs-7">Best for small business owners, startups who needes landing page.</p>
                                <Link href="/pricing" className="btn btn-primary border-dark w-100 mb-6">
                                    try for free
                                </Link>
                                <span className="btn-text">What's included:</span>
                                <ul className="list-unstyled mt-3 mb-0">
