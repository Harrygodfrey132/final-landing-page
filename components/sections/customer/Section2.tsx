...
export default function Section2() {
    return (
        <>
            ...
            <section className="seo-agency-customer-section-2 position-relative overflow-hidden pb-120">
                <div className="container">
                                ...
                                <div className="founder d-flex justify-content-between border-bottom pb-5">
                                    <div className="d-flex align-items-center">
                                        <div className="text-start ms-3">
                                            <Link href="#">
                                                <span className="btn-text">Chris James</span>
                                            </Link>
                                            <p className="mb-0 fs-7">Student</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="founder d-flex justify-content-between border-bottom pb-5">
                                    <div className="d-flex align-items-center">
                                        <div className="text-start ms-3">
                                            ...
                                            <p className="mb-0 fs-7">Parent</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="card-testimonial rounded-4 p-5 mb-lg-0 mb-5 h-100">
                                <div className="founder d-flex justify-content-between border-bottom pb-5">
                                    <div className="d-flex align-items-center">
                                        <div className="text-start ms-3">
                                            <Link href="#">
                                                <span className="btn-text">Sarom Ing</span>
                                            </Link>
                                            <p className="mb-0 fs-7">Parent</p>
                                        </div>
                                    </div>
                            ...
                            <div className="card-testimonial rounded-4 p-5 mb-lg-0 mb-5 h-100">
                                <div className="founder d-flex justify-content-between border-bottom pb-5">
                                    <div className="d-flex align-items-center">
                                        <div className="text-start ms-3">
                                            <Link href="#">
                                                <span className="btn-text">Charlotte Pitman</span>
                                            </Link>
                                            <p className="mb-0 fs-7">Student</p>
                                        </div>
                                    </div>
                            ...
                            <div className="card-testimonial rounded-4 p-5 mb-lg-0 mb-5 h-100">
                                <div className="founder d-flex justify-content-between border-bottom pb-5">
                                    <div className="d-flex align-items-center">
                                        <div className="text-start ms-3">
                                            <Link href="#">
                                                <span className="btn-text">Will W</span>
                                            </Link>
                                            <p className="mb-0 fs-7">Student</p>
                                        </div>
                                    </div>
                            ...
                            <div className="card-testimonial rounded-4 p-5 mb-lg-0 mb-5 h-100">
                                <div className="founder d-flex justify-content-between border-bottom pb-5">
                                    <div className="d-flex align-items-center">
                                        <div className="text-start ms-3">
                                            <Link href="#">
                                                <span className="btn-text">Lorenzo Mantilla Gutierrez</span>
                                            </Link>
                                            <p className="mb-0 fs-7">Student</p>
                                        </div>
                                    </div>
                            ...
                            <div className="card-testimonial rounded-4 p-5 mb-lg-0 mb-5 h-100">
                                <div className="founder d-flex justify-content-between border-bottom pb-5">
                                    <div className="d-flex align-items-center">
                                        <div className="text-start ms-3">
                                            <Link href="#">
                                                <span className="btn-text">Mahir Garg</span>
                                            </Link>
                                            <p className="mb-0 fs-7">Student</p>
                                        </div>
                                    </div>
                            ...
                            <div className="card-testimonial rounded-4 p-5 mb-lg-0 mb-5 h-100">
                                <div className="founder d-flex justify-content-between border-bottom pb-5">
                                    <div className="d-flex align-items-center">
                                        <div className="text-start ms-3">
                                            <Link href="#">
                                                <span className="btn-text">Louis Niesler</span>
                                            </Link>
                                            <p className="mb-0 fs-7">Student</p>
                                        </div>
                                    </div>
                    ...
                    <div className="row text-center justify-content-center mt-7">
                        <h6 className="text-primary mb-0 text-anime-style-3">
                            Hundreds of successful students <span className="text-dark"> have trusted us.</span>
                        </h6>
                        <div>
                            <Link href="/pricing" className="btn btn-outline-secondary mt-5">
